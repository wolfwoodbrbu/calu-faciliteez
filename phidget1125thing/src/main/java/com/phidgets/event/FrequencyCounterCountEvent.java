...
public class FrequencyCounterCountEvent {
	 ...
	 */
	public FrequencyCounterCountEvent(Phidget source, int index, int time,
			int count) {
		this.source = source;
		this.index = index;
		this.time = time;
	...
	/**
	 * Returns the amount of time in which the number of counts occured, in
	 * microseconds.
	 * 
	...
	public String toString() {
		...
		return source.toString() + " Channel " + index + ": " + count
				+ " pulses in " + time + " miroseconds";
	}
}
