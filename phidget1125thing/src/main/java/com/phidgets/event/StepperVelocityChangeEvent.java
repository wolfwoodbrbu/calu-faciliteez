...
public class StepperVelocityChangeEvent {
	...
	/**
	 * Return the velocity of the Stepper. This is reported back from the
	 * Stepper controller as the Stepper changes speed.
	 * 
	...
	public String toString() {
		return source.toString() + " Stepper velocity " + index
				+ " changed to " + value;
	}
}
