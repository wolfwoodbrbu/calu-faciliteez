...
/**
 * <p>
 * This class represents a Phidget Manager. The Phidget manager is a way to keep
 * track of attached phidgets, it will send Attach and Detach events as Phidgets
 * are added and removed fromt the system.
 * <p>
 * The Phidget manager deals in base Phidget objects. These objects are not
 * actually connected to opened Phidgets but can be used to get serial number,
 * name, version, etc.
 * 
 * @author Phidgets Inc.
 */
public class Manager {
	...
	/**
	 * The default constructor. Creating a Phidget Manager object will
	 * initialize the attach and detach handlers internally, but {@link #open()
	 * open} still needs to be called to actually receive event notifications.
	 */
	...
	/**
	 * Returns the Address of a Phidget Webservice when this Manager was opened
	 * as remote. This may be an IP Address or a hostname.
	 * 
	 * @return Server Address
	 * @throws PhidgetException
	 *             if this Manager was not opened.
	 */
	public final native String getServerAddress() throws PhidgetException;

	/**
	 * Returns the Server ID of a Phidget Webservice when this Manager was
	...
	/**
	 * Returns the Port of a Phidget Webservice when this Manager was opened as
	 * remote.
	 * 
	 * @return Server Port
	 * @throws PhidgetException
	...
	/**
	 * Starts the PhidgetManager. This method starts the phidget manager running
	 * in the base Phidget21 C library. If attach and detach listeners are to be
	 * used, they should be registered before start is called so that no events
	 * are missed. Once start is called, the Phidget Manager will be active
	 * until {@link #close() close} is called.
	 */
	...
	/**
	 * Shuts down the Phidget Manager. This method should be called to close
	 * down the Phidget Manager. Events will no longer be received. This method
	 * gets called automatically when the class is destroyed so calling it is
	 * not required.
	 */
	 ...
	 * called when a Phidget is phisically attached to the system, and has gone
	 * through its initalization, and so is ready to be used.
	 * <p>
	 ...
	 * called when a Phidget is phisically detached from the system, and is no
	 * longer available.
	 * <p>
	...
	/**
	 * Returns a list of Phidgets attached to the host computer. This list is
	 * updated right before the attach and detach events, and so will be up to
	 * date within these events.
	 * 
