...
/**
 * This class represents an a set of spatial data. It's used in the SpatialData
 * event.
 *
 * @author Phidget Inc.
 */
public final class SpatialEventData {
	 ...
	 *            the time since the last second in microseconds
	 */
	public SpatialEventData(double[] acceleration, double[] angularRate,
			double[] magneticField, int timeSeconds, int timeMicroSeconds) {
