...
/**
 * This class represents a Phidget Spatial. All methods for a PhidgetSpatial are
 * implemented in this class.
 * <p>
 * The Phidget Spatial may provide up to 3 axes of acceleration data, 3 axes of
 * angular rate data and 3 axes of magnetic field data.
 * 
 * @author Phidgets Inc.
 */
public final class SpatialPhidget extends Phidget {
	...
	/**
	 * Zeroes the gyroscope. This takes about two seconds and the gyro zxes will
	 * report 0 during the process. This should only be called when the board is
	 * not moving.
	 *
	 * @throws PhidgetException
	 *             If this Phidget is not opened and attached, or if the index
	...
	/**
	 * Sets the compass correction factors. This can be used to correcting any
	 * sensor errors, including hard and soft iron offsets and sensor error
	 * factors.
	 *
	 * @param magField
	 ...
	 *             open} for information on determining if a device is attached.
	 */
	public native void setCompassCorrectionParameters(double magField,
			double offset0, double offset1, double offset2, double gain0,
			double gain1, double gain2, double T0, double T1, double T2,
			double T3, double T4, double T5) throws PhidgetException;

	/**
	 * Resets the compass correction factors. Magnetic field data will be
	 * presented directly as reported by the sensor.
	 *
	 * @throws PhidgetException
	 *             If this Phidget is not opened and attached, or if the index
	 *             is out of range. See {@link com.phidgets.Phidget#open(int)
	 *             open} for information on determining if a device is attached.
	 */
	public native void resetCompassCorrectionParameters()
			throws PhidgetException;
	...
	/**
	 * Adds a spatial data listener. The spatial data handler is a method that
	 * will be called at a rate of {@link #getDataRate() DataRate} that has been
	 * set for the device. This event contains data for all axes of all sensors.
	 * <p>
	 * There is no limit on the number of spatial data handlers that can be
	 * registered for a particular Phidget.
	 * 
	 * @param l
	 *            An implemetation of the
	 *            {@link com.phidgets.event.SpatialDataListener
	 *            SpatialDataListener} interface
	 */
